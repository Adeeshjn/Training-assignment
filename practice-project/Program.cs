...
Difference();
// write a method that swaps them using temporary variable and without temp variable.
void SwapWithTemp()
{
    Console.WriteLine("Enter the first date:");
    DateTime dateTime1 = Convert.ToDateTime(Console.ReadLine());
    ...
    dateTime1 = dateTime2;
    dateTime2 = temp;
    Console.WriteLine($"The first date is {dateTime1} and the second date is {dateTime2}");
}
...
void SwapWithoutTemp()
{
    ...
    dateTime1 = dateTime1.Add(timeSpan);
